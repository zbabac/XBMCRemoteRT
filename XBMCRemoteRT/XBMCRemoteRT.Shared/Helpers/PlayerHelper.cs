    ...
    public class PlayerHelper
    {
        ...
        private static async Task RefreshPlayerItem(Players player)
        {
            ...
            catch (Exception x)
            {
                ...
                GlobalVariables.CurrentPlayerState.ItemId = 0;
                GlobalVariables.CurrentPlayerState.Title = "na";
                GlobalVariables.CurrentPlayerState.Artist = lista;
                GlobalVariables.CurrentPlayerState.Fanart = "";
                GlobalVariables.CurrentPlayerState.Thumbnail = "";
                GlobalVariables.CurrentPlayerState.ShowTitle = "";
                GlobalVariables.CurrentPlayerState.Tagline = "";*/
            }
        }
