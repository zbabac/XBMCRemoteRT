...
namespace XBMCRemoteRT
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void SleepServerMFI_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ConnectionItem selectedConnection = (ConnectionItem)(sender as MenuFlyoutItem).DataContext;
                ConnectionManager.CurrentConnection = selectedConnection;
                Input.ExecuteAction(SystemCommands.Suspend);
            }
            catch
            {
                Exception x;
        ...
        private void RebootServerMFI_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ConnectionItem selectedConnection = (ConnectionItem)(sender as MenuFlyoutItem).DataContext;
        ...
        private void ShutdownServerMFI_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ConnectionItem selectedConnection = (ConnectionItem)(sender as MenuFlyoutItem).DataContext;
                ConnectionManager.CurrentConnection = selectedConnection;
                Input.ExecuteAction(SystemCommands.Shutdown);
            }
            catch
            {
                Exception x;
